        ...
        <div class="py-10 shadow-2xl shadow-black rounded-lg">
            <form method="POST" action="{{ route('contact.index') }}">
                ...
                <div class="pb-10">
                    ...
                    <div class="px-4 md:px-0 py-2">
                        <input id="subject" type="text" class="py-2 w-full md:w-1/2 lg:w-1/3 rounded-lg @error('subject') is-invalid border-red-600 outline-none @enderror" name="subject">
                ...
                <div class="pb-10">
                    ...
                    <div class="px-4 md:px-0 py-2">
                        <textarea name="contact_message" id="contact_message" rows="10" class="py-2 w-full md:w-1/2 lg:w-1/3 rounded-lg @error('contact_message') is-invalid border-red-600 outline-none @enderror"></textarea>
