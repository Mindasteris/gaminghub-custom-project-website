...
@section('content')
    <div class="max-w-[1240px] mx-auto text-center">
         ...
         <div class="py-10 shadow-2xl shadow-black rounded-lg">
            <form method="POST" action="{{ route('community.update', $comment->id) }}">
                @csrf
                @method('PATCH')
                <div class="pb-10">
                    ...
                    <div class="px-4 md:px-0 py-2">
                        <input id="name" type="text" class="py-2 w-full md:w-1/2 lg:w-1/3 rounded-lg @error('name') is-invalid border-red-600 outline-none @enderror" name="name" autofocus value="{{ $comment->name }}">
                ...
                <div class="pb-10">
                    ...
                    <div class="px-4 md:px-0 py-2">
                        <input id="title" type="text" class="py-2 w-full md:w-1/2 lg:w-1/3 rounded-lg @error('title') is-invalid border-red-600 outline-none @enderror" name="title" value="{{ $comment->title }}">
                ...
                <div class="pb-10">
                    ...
                    <div class="px-4 md:px-0 py-2">
                        <textarea name="comment" id="comment" rows="10" class="py-2 w-full md:w-1/2 lg:w-1/3 rounded-lg @error('comment') is-invalid border-red-600 outline-none @enderror">{{ $comment->comment }}</textarea>
